...
$language_data = array (
    ...
    'STYLES' => array(
        'COMMENTS' => array(
            1 => 'color: #0000FF;', // single quote strings
            2 => 'color: #0000FF;', // double quote strings
            3 => 'color: #FF00FF;', // single quote strings
            4 => 'color: #FF00FF;', // double quote strings
            5 => 'color: #0000FF;', // block comments
