...
<form action="admin.site.index.{$bid}" method="post">
  网站标题：
  <input type="text" name="site_name" value="{#SITE_NAME#}"><br/>
  网站简称：
  <input type="text" name="site_simple_name" value="{#SITE_SIMPLE_NAME#}"><br/>
  论坛名称：
  <input type="text" name="bbs_name" value="{#BBS_NAME#}"><br/>
  论坛首页名称：
  <input type="text" name="bbs_index_name" value="{#BBS_INDEX_NAME#}"><br/>
