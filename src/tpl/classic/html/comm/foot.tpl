{if !$base}
	...
	<div class="tp">
		...
		<p>
			...
			{if $host == "ssl.hu60.cn"}主站(ssl){else}<a href="https://ssl.hu60.cn{$smarty.server.REQUEST_URI|code}">主站(ssl)</a>{/if} |
			{if $host == "360.cdn.hu60.cn"}360(ssl){else}<a href="https://360.cdn.hu60.cn{$smarty.server.REQUEST_URI|code}">360(ssl)</a>{/if} |
