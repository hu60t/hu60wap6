...
{$url="{$CID}.{$PID}.{$BID}?keywords={$smarty.get.keywords|urlenc}&amp;username={$smarty.get.username|urlenc}&amp;searchType={$smarty.get.searchType|urlenc}&amp;showBot={$smarty.get.showBot|urlenc}&amp;onlyReview={$smarty.get.onlyReview|urlenc}&amp;p="}
